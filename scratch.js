...
function changeimg2()
{
    $("body").css('background-image','url(images/project-counter.jpg)');
}
function changeimg3()
{
    $("body").css('background-image','url(images/girl.jpg)');
}
...
var val = document.getElementById('contentedit').value
